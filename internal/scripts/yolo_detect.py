...
def yolo_detect(model_path, name_of_count):
    ...
    input_dir = cwd + "/detections/" + name_of_count + "/images/bounding"
    output_dir = cwd + "/detections/" + name_of_count + "/images/bounding"
    ...
    for sub_dir in os.listdir(input_dir):
        ...
        for img in Path(os.path.join(input_dir, sub_dir)).glob("*.png"):
            ...
            # Move annotated image file to /bounding/
    ...
    excel_path = cwd + "/detections/" + name_of_count + "/spreadsheets/overall_counts.xlsx"
